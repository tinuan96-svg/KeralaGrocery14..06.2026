...
import { ShoppingCart, Heart, User, Package, LogOut, Search, LogIn, X, ShieldCheck, Wallet, Phone, ChevronDown, Menu } from 'lucide-react';
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4">
          <div className="flex h-[60px] items-center justify-between gap-2 sm:gap-3">
            ...
            {/* ── Logo + mobile categories ── */}
            <div className="flex items-center gap-1.5 flex-shrink-0">
              <button
                onClick={() => setCategoryDrawerOpen(true)}
                className="lg:hidden w-9 h-9 flex items-center justify-center rounded-xl hover:bg-[#f4faf6] transition-colors"
                aria-label="Open categories"
              >
                <Menu className="h-[20px] w-[20px] text-gray-700" />
              </button>
              <Link href="/" className="flex items-center gap-2 group min-w-0" aria-label="Kerala Grocery UK Home">
            ...
            {/* ── Desktop search ── */}
            <LiveSearch
              className="flex-1 max-w-[340px] hidden md:block"
              placeholder="Search rice, spices, snacks, brands..."
            />
