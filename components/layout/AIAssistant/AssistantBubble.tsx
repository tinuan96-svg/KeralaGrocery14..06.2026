    ...
    <AnimatePresence>
      {bubbleText && (
        <motion.div
          ...
          animate="visible"
          exit="exit"
          className="fixed bottom-[180px] right-10 z-[60] max-w-[240px]"
        >
          <div className="relative bg-white border-2 border-[#0B5D3B] rounded-[2.5rem] rounded-br-none shadow-2xl p-5 pr-10">
            ...
            <div className="absolute -bottom-2 right-6 w-6 h-6 bg-white border-r-2 border-b-2 border-[#0B5D3B] rotate-45" />
          </div>
        </motion.div>
      )}
    </AnimatePresence>
