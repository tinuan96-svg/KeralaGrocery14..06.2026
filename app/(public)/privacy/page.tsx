    ...
    <main className="bg-white">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <Section id="third-party-services" title="4. Third-Party Services">
          ...
          <p>
            Card payments are processed through <strong>Trust Payments</strong>. These providers are PCI-DSS
            compliant. We do not store or access your full card number. Please refer to Trust Payments&apos;
            respective privacy policy for information on how they handle payment data.
          </p>
